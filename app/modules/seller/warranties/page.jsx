    ...
    const fetchWarranties = async () => {
      try {
        ...
        if (response.ok) {
          ...
          throw new Error("Error loading warranties")
        }
      } catch (error) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100">Warranties</h1>
        <Link href="/seller/warranties/new">
          <Button className="bg-blue-600 hover:bg-blue-700">New Warranty</Button>
        </Link>
      </div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center h-64 bg-blue-50 dark:bg-blue-900/20 rounded-md border border-blue-200 dark:border-blue-800 p-6">
          <h3 className="text-xl font-medium mb-2 text-blue-700 dark:text-blue-400">No Warranties Found</h3>
